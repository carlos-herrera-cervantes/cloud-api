...
namespace Api.Tests.Api.Web.Controllers
{
    public class UserControllerTests
    {
        ...
        public async Task GetAllAsync_ShouldReturn_UsersList()
        {
            ...
            mockRepository.Setup(repo => repo.GetAllAsync(It.IsAny<ListResourceRequest>())).ReturnsAsync(_users);
            mockRepository.Setup(repo => repo.CountAsync(It.IsAny<ListResourceRequest>())).ReturnsAsync(2);

            var userController = new UserController(mockManager.Object, mockRepository.Object, mockOperationHandler.Object);
            
            var result = await userController.GetAllAsync(request);
        ...
        public async Task GetByStation_ShouldReturn_Users_BySpecificStation()
        {
            ...
            var result = await userController.GetByStation(request);
            var response = result as OkObjectResult;
            var responseBody = response.Value as ListUserResponse;
        ...
        public async Task GetMeAsync_ShouldReturn_SingleUser()
        {
            ...
            var result = await userController.GetMeAsync();
            var response = result as OkObjectResult;
        ...
        public async Task GetByIdAsync_ShouldReturn_SingleUser()
        {
            ...
            var result = await userController.GetByIdAsync("60f0cae6b06995113987163c");
            var response = result as OkObjectResult;
            var responseBody = response.Value as SingleUserResponse;
        ...
        public async Task UpdateByIdAsync_ShouldReturn_UpdatedUser()
        {
            ...
            var result = await userController.UpdateByIdAsync("60f0cae6b06995113987163c", updatedProperties);
            var response = result as OkObjectResult;
            var responseBody = response.Value as SingleUserResponse;
        ...
        public async Task DeleteByIdAsync_ShouldDelete_SpecificUser()
        {
            ...
            var result = await userController.DeleteByIdAsync("5fd5ddc549c67b3c6527462f");
