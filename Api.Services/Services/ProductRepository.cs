...
namespace Api.Services.Services
{
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<IEnumerable<Product>> GetAllAsync(Request request) => await _productRepository.GetAllAsync(request, null);
        ...
        public async Task<int> CountAsync(Request request) => await _productRepository.CountAsync(request);
    }
}