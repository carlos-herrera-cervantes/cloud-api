...
namespace Api.Services.Services
{
    public class CustomerPurchaseRepository : ICustomerPurchaseRepository
    {
        ...
        public async Task<IEnumerable<CustomerPurchase>> GetAllAsync(Request request)
        ...
        public async Task<int> CountAsync(Request request) => await _customerPurchaseRepository.CountAsync(request);
    }
}