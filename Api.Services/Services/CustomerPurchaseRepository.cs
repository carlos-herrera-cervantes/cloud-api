...
namespace Api.Services.Services
{
    public class CustomerPurchaseRepository : ICustomerPurchaseRepository
    {
        ...
        public async Task<CustomerPurchase> GetOneAsync(ListResourceRequest request) => await _customerPurchaseRepository.GetOneAsync(request);

        public async Task<int> CountAsync(ListResourceRequest request) => await _customerPurchaseRepository.CountAsync(request);
    }
}