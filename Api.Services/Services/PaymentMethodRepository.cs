...
namespace Api.Services.Services
{
    public class PaymentMethodRepository : IPaymentMethodRepository
    {
        ...
        public async Task<IEnumerable<PaymentMethod>> GetAllAsync(Request request)
        ...
        public async Task<int> CountAsync(Request request) => await _paymentMethodRepository.CountAsync(request);
    }
}